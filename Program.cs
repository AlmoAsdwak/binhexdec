            ...
            while (true)
            {
                ...
                if (IsHex(number))
                {
                    if (Regex.IsMatch(number, "^[01]+$"))
                    {
                        ...
                        Console.WriteLine("Decimal: " + Convert.ToInt32(number, 2));
                        Console.WriteLine("Hexidecimal: " + Convert.ToString(Convert.ToInt32(number, 2), 16).ToUpper());
                    }
                    else
                    {
                        Console.WriteLine("Vaše číslo: " + number);
